...
<head>
    ...
    <title>Editar Categoria de Filme - SchweizerPine Shopping</title>
...
<main>
    <section class="cadastro-container">
        <div class="form-box">
            ...
            <?php endif; ?>
            <h2>Editar Categoria (Filme)</h2>
            <form action="/SistemaShopping_web1/src/controller/cadastro/registrar_categoria_filme.php" method="post" enctype="multipart/form-data">
                <label for="nomeCategoria">Categoria</label>
                <input type="text" id="nomeCategoria" name="categoria" placeholder="Digite o nome da categoria" value="<?= htmlspecialchars($nome) ?>" required>
                <input type="hidden" id="id" name="id" value="<?= htmlspecialchars($id) ?>"/>
                <input class="btn-cadastrar" type="submit" value="Editar"/>
            </form>
        </div>
    </section>
</main>
