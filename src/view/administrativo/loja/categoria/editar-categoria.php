...
<head>
    ...
    <title>Cadastrar Categoria de Loja - SchweizerPine Shopping</title>
...
<main>
    <section class="cadastro-container">
        <div class="form-box">
            ...
            <?php endif; ?>
            <h2>Cadastro de Categoria (Loja)</h2>
            <form action="/SistemaShopping_web1/src/controller/cadastro/registrar_categoria_loja.php" method="post" enctype="multipart/form-data">
